...
__wxAppCode__['pages/income/income.json']={"navigationBarTitleText":"收益","titleNView":{"splitLine":{"color":"#F4F4F4"}},"animationType":"pop-in","animationDuration":300,"usingComponents":{"tabbar":"/components/tabbar"}};
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/index"],{"0959":function(e,t,o){},"1d88":function(e,t,o){"use strict";var n=o("0959"),i=o.n(n);i.a},4941:function(e,t,o){"use strict";o.r(t);var n=o("fce8"),i=o("b372");for(var a in i)"default"!==a&&function(e){o.d(t,e,function(){return i[e]})}(a);o("1d88");var s=o("2877"),c=Object(s["a"])(i["default"],n["a"],n["b"],!1,null,"c118647e",null);t["default"]=c.exports},"8c46":function(e,t,o){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=i(o("61f8"));function i(e){return e&&e.__esModule?e:{default:e}}var a,s=function(){return o.e("components/tabbar").then(o.bind(null,"62c7"))},c=(e.createCanvasContext("firstCanvas"),{data:function(){return{video_id:0,url:"",tag_img:"",poster_img:"http://wkyt.demenk.com/wap/app/poster.jpg",controls:!1,autoplay:!0,progress:!1,member_watch:100,member_video:100,play:!0,title:"20/16",avatar:"",collect:"0",love:"0",comment:"0",share:"0",type:"新惠设计主流款...",info:"高品质制造平台,三体系认证,十环认证 平台,三体系认证十环认证平台,三体系认证,十环认证高品质制造",red_title:"奔驰汽车",red_info:"领导时代，驾驭未来",money:0,red_show:!1,money_show:!1,percent:0,subject:[],current:0,pages:0,page:1,icons:"",subjectList:[],videoContext:"",isPlay:1,isOne:0,wapUrl:"",status:"",num:0,video_num:0}},components:{tabbar:s},methods:{preventTouchMove:function(){},startPause:function(){console.log("tap"," at pages\\index\\index.vue:100"),1==this.isPlay?(this.videoContext.pause(),this.isPlay=0):(this.videoContext.play(),this.isPlay=1)},open_red:function(){var t=this;1==this.num?(this.red_title="",this.red_info="",e.navigateTo({url:"/pages/awards/awards"})):n.default.post("index.php?act=video&op=reward",{video_id:this.video_id}).then(function(e){t.money=e.amount,t.red_title="",t.red_info=e.message,t.red_show=!1,t.money_show=!0})},close_money:function(){this.money_show=!1},toAvatar:function(){e.navigateTo({url:"/pages/business_info/business_info?video_id="+this.video_id})},toCollect:function(){var e=this;n.default.get("index.php?act=video&op=videoCollection",{video_id:this.video_id}).then(function(t){0==t.code&&(e.collect=t.v_star_count)})},toLove:function(){var e=this;n.default.get("index.php?act=video&op=fabulous",{video_id:this.video_id}).then(function(t){0==t.code&&(e.love=t.v_like_count)})},toShare:function(){var t=this;n.default.get("index.php?act=video&op=forward",{video_id:this.video_id}).then(function(o){0==o.code&&e.showModal({title:"提示",content:"分享需要下载此视频，确认下载？",success:function(o){if(o.confirm){e.showLoading({title:"下载中"});var n=e.downloadFile({url:t.url,success:function(t){200===t.statusCode&&(console.log(t.tempFilePath," at pages\\index\\index.vue:194"),e.saveVideoToPhotosAlbum({filePath:t.tempFilePath,success:function(){e.hideLoading(),e.showToast({title:"视频已保存到相册，请到其他平台分享",icon:"none"})}}))},fail:function(t){e.showToast({title:t.errMsg,icon:"none"})}});n.onProgressUpdate(function(t){e.showToast({title:"下载中: "+t.progress+"%",icon:"none"}),console.log("下载进度"+t.progress," at pages\\index\\index.vue:223"),100==t.progress&&e.hideLoading()})}},fail:function(e){console.log(e," at pages\\index\\index.vue:236")}})})},toComment:function(){console.log(this.comment," at pages\\index\\index.vue:244"),console.log(this.video_id," at pages\\index\\index.vue:245"),e.navigateTo({url:"/pages/comment/comment?comment_count="+this.comment+"&video_id="+this.video_id})},touchstart:function(e){a=e.changedTouches[0]},touchmove:function(e){},touchend:function(e){this.getDirect(a,e.changedTouches[0])},touchcancel:function(e){this.getDirect(a,e.changedTouches[0])},getDirect:function(e,t){var o=t.pageX-e.pageX,n=t.pageY-e.pageY;Math.abs(o)>Math.abs(n)&&o>0?console.log("right"," at pages\\index\\index.vue:272"):Math.abs(o)>Math.abs(n)&&o<0?console.log("left"," at pages\\index\\index.vue:275"):Math.abs(n)>Math.abs(o)&&n>0?(console.log("bottom"," at pages\\index\\index.vue:278"),this.pre()):Math.abs(n)>Math.abs(o)&&n<0&&(console.log("top"," at pages\\index\\index.vue:282"),this.next())},loadData:function(){var t=this;e.showLoading({title:"视频加载中..."}),t.video_num++,n.default.post("index.php?act=video&op=getOne",{video_num:t.video_num}).then(function(o){console.log(o.v_id," at pages\\index\\index.vue:294"),t.video_id=o.v_id,t.url=o.url,t.avatar=o.store_logo,t.tag_img=o.tag_img,t.type=o.v_title,t.info=o.v_desc,t.collect=o.v_star_count,t.love=o.v_like_count,t.comment=o.v_comment_count,t.share=o.v_forward_count,t.title=o.member_watch+"/"+o.member_video,t.status=o.status,t.num=o.num,1==t.num&&(t.video_num=0),console.log(t.avatar," at pages\\index\\index.vue:311"),e.hideLoading()})},changeSubject:function(){this.loadData()},timeupdate:function(e){var t=e.detail.currentTime,o=e.detail.duration,n=Math.round(t/o*1e4)/100;this.percent=n},ended:function(){2!=this.num&&0==this.isOne&&(this.red_show=!0,this.isOne=1,this.videoContext.pause())},toResetPlay:function(){this.videoContext.play(),this.money_show=!1},toNextPlay:function(){this.next()},pre:function(){var e=this;e.changeSubject(e.current-1),e.red_show=!1,e.money_show=!1,e.isPlay=1,e.isOne=0},next:function(){var e=this;e.changeSubject(e.current+1),e.red_show=!1,e.money_show=!1,e.isPlay=1,e.isOne=0}},onLoad:function(){var t=this;t.wapUrl=n.default.config.wapUrl,console.log(t.wapUrl," at pages\\index\\index.vue:376"),t.videoContext=e.createVideoContext("myVideo"),t.loadData()},onShow:function(){this.videoContext.play(),this.isPlay=1},onHide:function(){this.isPlay=0,this.videoContext.pause()},onPullDownRefresh:function(){},onReachBottom:function(){},onPageScroll:function(e){}});t.default=c}).call(this,o("6e42")["default"])},b372:function(e,t,o){"use strict";o.r(t);var n=o("8c46"),i=o.n(n);for(var a in n)"default"!==a&&function(e){o.d(t,e,function(){return n[e]})}(a);t["default"]=i.a},fce8:function(e,t,o){"use strict";var n=function(){var e=this,t=e.$createElement;e._self._c},i=[];o.d(t,"a",function(){return n}),o.d(t,"b",function(){return i})}},[["1891","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/store/store"],{"1e87":function(e,t,n){"use strict";n.r(t);var o=n("7b91"),r=n("8486");for(var u in r)"default"!==u&&function(e){n.d(t,e,function(){return r[e]})}(u);n("7960");var a=n("2877"),s=Object(a["a"])(r["default"],o["a"],o["b"],!1,null,"72846aba",null);t["default"]=s.exports},7960:function(e,t,n){"use strict";var o=n("c5d3"),r=n.n(o);r.a},"7b91":function(e,t,n){"use strict";var o=function(){var e=this,t=e.$createElement;e._self._c},r=[];n.d(t,"a",function(){return o}),n.d(t,"b",function(){return r})},8486:function(e,t,n){"use strict";n.r(t);var o=n("f900"),r=n.n(o);for(var u in o)"default"!==u&&function(e){n.d(t,e,function(){return o[e]})}(u);t["default"]=r.a},c5d3:function(e,t,n){},f900:function(e,t,n){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o=u(n("bebd")),r=n("2f62");function u(e){return e&&e.__esModule?e:{default:e}}var a=function(){return n.e("components/tabbar").then(n.bind(null,"62c7"))},s={data:function(){return{url:"",webviewStyles:{progress:{color:"#FF3333"}}}},components:{tabbar:a},computed:(0,r.mapState)(["forcedLogin","hasLogin","userName"]),methods:{},onShow:function(){e.startPullDownRefresh(),e.getStorageSync("access_token")?(this.url=o.default.wapUrl+"index.html?uid=50&key="+e.getStorageSync("access_token"),console.log(this.url," at pages\\store\\store.vue:48")):e.navigateTo({url:"/pages/login/login"})},onPullDownRefresh:function(){var t=this;setTimeout(function(){t.url=o.default.wapUrl+"index.html?uid=50&key="+e.getStorageSync("access_token"),console.log(t.url," at pages\\store\\store.vue:59"),e.stopPullDownRefresh()},1e3)}};t.default=s}).call(this,n("6e42")["default"])}},[["06a2","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/income/income"],{"0ebc":function(t,e,n){},"1ef8":function(t,e,n){"use strict";n.r(e);var a=n("caa0"),i=n.n(a);for(var o in a)"default"!==o&&function(t){n.d(e,t,function(){return a[t]})}(o);e["default"]=i.a},"4ad4":function(t,e,n){"use strict";n.r(e);var a=n("4ae4"),i=n("1ef8");for(var o in i)"default"!==o&&function(t){n.d(e,t,function(){return i[t]})}(o);n("86da");var r=n("2877"),u=Object(r["a"])(i["default"],a["a"],a["b"],!1,null,"3575aeb4",null);e["default"]=u.exports},"4ae4":function(t,e,n){"use strict";var a=function(){var t=this,e=t.$createElement;t._self._c},i=[];n.d(e,"a",function(){return a}),n.d(e,"b",function(){return i})},"86da":function(t,e,n){"use strict";var a=n("0ebc"),i=n.n(a);i.a},caa0:function(t,e,n){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var a=i(n("61f8"));i(n("b2a1"));function i(t){return t&&t.__esModule?t:{default:t}}var o=function(){return n.e("components/tabbar").then(n.bind(null,"62c7"))},r={data:function(){return{money:"0.00",income:"0.00",total_page_count:1,cash_count:1,navbar:[{name:"收益记录"},{name:"提现"}],currentTab:0,income_list:[],withdraw_list:[],income_page_number:1,withdraw_page_number:1}},components:{tabbar:o},methods:{navbarTap:function(t){this.currentTab=t,this.income_page_number=1,this.withdraw_page_number=1,0==this.currentTab?this.getRewardList():this.getWithdrawList()},getRewardList:function(){var t=this;console.log(this.income_page_number," at pages\\income\\income.vue:89"),a.default.get("index.php?act=predeposit&op=pd_list",{curpage:this.income_page_number}).then(function(e){for(var n in t.money=e.available_predeposit,t.income=e.total_reward_amount,t.total_page_count=e.page.total_page_count,e.list)t.income_list.push({time:e.list[n].lg_add_time,info:e.list[n].lg_desc,num:e.list[n].lg_av_amount})})},getWithdrawList:function(){var t=this;a.default.get("index.php?act=predeposit&op=pd_cash_list",{curpage:this.withdraw_page_number}).then(function(e){for(var n in t.cash_count=e.cash_count,e.cash_list)t.withdraw_list.push({time:e.list[n].lg_add_time,info:e.cash_list[n].info,num:e.cash_list[n].pdc_amount})})}},onLoad:function(){this.getRewardList()},onReachBottom:function(){var e=this;if(0==e.currentTab){var n=e.income_page_number+1;if(e.total_page_count<n)return t.showToast({title:"暂无更多加载",duration:2e3,icon:"none"}),!1;t.showLoading({title:"加载中"}),e.income_page_number=e.income_page_number+1,setTimeout(function(){e.getRewardList(),t.hideLoading()},1e3)}else{var a=e.withdraw_page_number+1;if(console.log(e.cash_count," at pages\\income\\income.vue:148"),console.log(a," at pages\\income\\income.vue:149"),e.cash_count<a)return t.showToast({title:"暂无更多加载",duration:2e3,icon:"none"}),!1;t.showLoading({title:"加载中"}),e.withdraw_page_number=e.withdraw_page_number+1,setTimeout(function(){e.getWithdrawList(),t.hideLoading()},1e3)}},onPullDownRefresh:function(){var e=this;e.income_page_number=1,e.withdraw_page_number=1,setTimeout(function(){e.getRewardList(),t.stopPullDownRefresh()},1e3)}};e.default=r}).call(this,n("6e42")["default"])}},[["bac4","common/runtime","common/vendor"]]]);
});
