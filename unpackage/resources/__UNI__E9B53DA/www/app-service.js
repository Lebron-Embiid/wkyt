...
var o2B=_mz(z,'m-input',['clearable',-1,'bind:__l',1,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(h1B,o2B)
var c3B=_mz(z,'m-input',['bind:__l',9,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(h1B,c3B)
var o4B=_mz(z,'m-input',['displayable',-1,'bind:__l',17,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(h1B,o4B)
var l5B=_mz(z,'m-input',['displayable',-1,'bind:__l',25,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(h1B,l5B)
_(r,h1B)
return r
}
...
var e8B=_mz(z,'m-input',['clearable',-1,'bind:__l',1,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(t7B,e8B)
var b9B=_mz(z,'m-input',['bind:__l',9,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(t7B,b9B)
var o0B=_mz(z,'m-input',['displayable',-1,'bind:__l',17,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(t7B,o0B)
_(r,t7B)
return r
}
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/index"],{"0798":function(t,e,n){},"355d":function(t,e,n){"use strict";var o=n("0798"),i=n.n(o);i.a},3792:function(t,e,n){"use strict";var o=function(){var t=this,e=t.$createElement;t._self._c},i=[];n.d(e,"a",function(){return o}),n.d(e,"b",function(){return i})},"381d":function(t,e,n){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var o,i=a(n("61f8"));function a(t){return t&&t.__esModule?t:{default:t}}var c={data:function(){return{video_id:0,url:"",tag_img:"",poster_img:"../../static/img/poster.jpg",controls:!1,autoplay:!0,progress:!1,play:!0,title:"20/16",avatar:"../../static/img/index_avatar.png",collect:"566w",love:"13.8w",comment:"0",share:"1.2w",type:"新惠设计主流款...",info:"高品质制造平台,三体系认证,十环认证 平台,三体系认证十环认证平台,三体系认证,十环认证高品质制造",red_title:"奔驰汽车",red_info:"领导时代，驾驭未来",money:0,red_show:!1,money_show:!1,percent:0,subject:[],current:0,pages:0,page:1,icons:"",subjectList:[]}},methods:{open_red:function(){var t=this;i.default.post("index.php?act=video&op=reward",{video_id:this.video_id}).then(function(e){t.money=e.amount,t.red_title="",t.red_info=e.message,t.red_show=!1,t.money_show=!0})},close_money:function(){this.money_show=!1},toCollect:function(){i.default.get("index.php?act=video&op=videoCollection",{video_id:this.video_id}).then(function(t){})},toLove:function(){i.default.get("index.php?act=video&op=fabulous",{video_id:this.video_id}).then(function(t){})},toShare:function(){i.default.get("index.php?act=video&op=forward",{video_id:this.video_id}).then(function(t){})},toComment:function(){t.navigateTo({url:"/pages/comment/comment?comment_count="+this.comment+"&video_id="+this.video_id})},touchstart:function(t){o=t.changedTouches[0]},touchmove:function(t){},touchend:function(t){this.getDirect(o,t.changedTouches[0])},touchcancel:function(t){this.getDirect(o,t.changedTouches[0])},getDirect:function(t,e){var n=e.pageX-t.pageX,o=e.pageY-t.pageY;Math.abs(n)>Math.abs(o)&&n>0?console.log("right"," at pages\\index\\index.vue:143"):Math.abs(n)>Math.abs(o)&&n<0?console.log("left"," at pages\\index\\index.vue:146"):Math.abs(o)>Math.abs(n)&&o>0?(console.log("bottom"," at pages\\index\\index.vue:149"),this.pre()):Math.abs(o)>Math.abs(n)&&o<0&&(console.log("top"," at pages\\index\\index.vue:153"),this.next())},loadData:function(t,e){var n=this;n.page=t,i.default.post("index.php?act=video&op=getOne",{}).then(function(t){n.video_id=t.v_id,n.url=t.v_url,n.avatar=t.store_logo,n.tag_img=t.tag_img,n.type=t.v_title,n.info=t.v_desc,n.collect=t.v_star_count,n.love=t.v_like_count,n.comment=t.v_comment_count,n.share=t.v_forward_count})},changeSubject:function(e){var n=this;e<0&&(e=0,t.showToast({title:"请往上滑",duration:2e3,icon:"none"})),e=e||0;var o=n.subjectList;o.length<=e||n.loadData(n.page+1)},timeupdate:function(t){var e=t.detail.currentTime,n=t.detail.duration,o=Math.round(e/n*1e4)/100;this.percent=o},pre:function(){this.changeSubject(this.current-1)},next:function(){this.changeSubject(this.current+1)}},onLoad:function(){var t=this;t.loadData(1,this.changeSubject),setTimeout(function(){t.red_show=!0},5e3)},onPullDownRefresh:function(){},onReachBottom:function(){},onPageScroll:function(t){console.log(t," at pages\\index\\index.vue:242")}};e.default=c}).call(this,n("6e42")["default"])},4941:function(t,e,n){"use strict";n.r(e);var o=n("3792"),i=n("b372");for(var a in i)"default"!==a&&function(t){n.d(e,t,function(){return i[t]})}(a);n("355d");var c=n("2877"),u=Object(c["a"])(i["default"],o["a"],o["b"],!1,null,"70521794",null);e["default"]=u.exports},b372:function(t,e,n){"use strict";n.r(e);var o=n("381d"),i=n.n(o);for(var a in o)"default"!==a&&function(t){n.d(e,t,function(){return o[t]})}(a);e["default"]=i.a}},[["1891","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/store/store"],{"1e87":function(e,t,o){"use strict";o.r(t);var n=o("2107"),a=o("8486");for(var r in a)"default"!==r&&function(e){o.d(t,e,function(){return a[e]})}(r);var u=o("2877"),s=Object(u["a"])(a["default"],n["a"],n["b"],!1,null,"30c18c1c",null);t["default"]=s.exports},2107:function(e,t,o){"use strict";var n=function(){var e=this,t=e.$createElement;e._self._c},a=[];o.d(t,"a",function(){return n}),o.d(t,"b",function(){return a})},8486:function(e,t,o){"use strict";o.r(t);var n=o("ca54"),a=o.n(n);for(var r in n)"default"!==r&&function(e){o.d(t,e,function(){return n[e]})}(r);t["default"]=a.a},ca54:function(e,t,o){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=r(o("bebd")),a=o("2f62");function r(e){return e&&e.__esModule?e:{default:e}}var u={data:function(){return{url:"",webviewStyles:{progress:{color:"#FF3333"}}}},computed:(0,a.mapState)(["forcedLogin","hasLogin","userName"]),methods:{},onShow:function(){console.log(n.default.wapUrl," at pages\\store\\store.vue:37"),console.log(e.getStorageSync("access_token")," at pages\\store\\store.vue:38"),this.hasLogin?(this.url=n.default.wapUrl+"index.html?uid=50&key="+e.getStorageSync("access_token"),console.log(this.url," at pages\\store\\store.vue:42")):e.navigateTo({url:"/pages/login/login"})}};t.default=u}).call(this,o("6e42")["default"])}},[["06a2","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/income/income"],{"1ef8":function(e,n,t){"use strict";t.r(n);var a=t("afe2"),o=t.n(a);for(var i in a)"default"!==i&&function(e){t.d(n,e,function(){return a[e]})}(i);n["default"]=o.a},"34b4":function(e,n,t){"use strict";var a=t("4fcf"),o=t.n(a);o.a},"4ad4":function(e,n,t){"use strict";t.r(n);var a=t("5e03"),o=t("1ef8");for(var i in o)"default"!==i&&function(e){t.d(n,e,function(){return o[e]})}(i);t("34b4");var u=t("2877"),r=Object(u["a"])(o["default"],a["a"],a["b"],!1,null,"4d72e1f5",null);n["default"]=r.exports},"4fcf":function(e,n,t){},"5e03":function(e,n,t){"use strict";var a=function(){var e=this,n=e.$createElement;e._self._c},o=[];t.d(n,"a",function(){return a}),t.d(n,"b",function(){return o})},afe2:function(e,n,t){"use strict";Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var a=i(t("61f8")),o=i(t("b2a1"));function i(e){return e&&e.__esModule?e:{default:e}}var u={data:function(){return{money:"0.00",income:"0.00",navbar:[{name:"收益记录"},{name:"提现"}],currentTab:0,income_list:[],withdraw_list:[],income_page_number:1}},methods:{navbarTap:function(e){this.currentTab=e}},onLoad:function(){var e=this;a.default.post("index.php?act=predeposit&op=pd_list",{page:this.income_page_number}).then(function(n){for(var t in e.money=n.available_predeposit,e.income=n.total_reward_amount,n.list)console.log(n.list[t]," at pages\\income\\income.vue:90"),e.income_list.push({time:o.default.formatTime(n.list[t].lg_add_time,"Y-m-d"),info:n.list[t].lg_desc,num:n.list[t].lg_av_amount})})}};n.default=u}},[["bac4","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/person/person"],{"124e":function(t,e,n){"use strict";n.r(e);var a=n("fa07"),o=n("c9a3");for(var r in o)"default"!==r&&function(t){n.d(e,t,function(){return o[t]})}(r);n("6089");var u=n("2877"),c=Object(u["a"])(o["default"],a["a"],a["b"],!1,null,"961cdfc8",null);e["default"]=c.exports},"380a":function(t,e,n){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var a=n("2f62");function o(t){for(var e=1;e<arguments.length;e++){var n=null!=arguments[e]?arguments[e]:{},a=Object.keys(n);"function"===typeof Object.getOwnPropertySymbols&&(a=a.concat(Object.getOwnPropertySymbols(n).filter(function(t){return Object.getOwnPropertyDescriptor(n,t).enumerable}))),a.forEach(function(e){r(t,e,n[e])})}return t}function r(t,e,n){return e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}var u={data:function(){return{code:"",id:"",avatar_url:"../../static/img/person_avatar.png",money:0,nickname:"",orders:[],status_0:0,status_1:0,status_2:0,status_3:0}},methods:o({},(0,a.mapMutations)(["logout"]),{toSettings:function(e){t.navigateTo({url:"/pages/settings/settings"})},logOut:function(){this.logout(),t.clearStorageSync(),t.showToast({title:"退出成功",icon:"none"}),setTimeout(function(){t.reLaunch({url:"/pages/login/login"})},1500)}}),onLoad:function(){var e=this;e.$access_token=t.getStorageSync("access_token"),t.request({url:e.$api+"index.php?act=member&key="+e.$access_token,method:"POST",dataType:"json",header:{"content-type":"application/x-www-form-urlencoded"},success:function(n){if(n.data.datas.error)t.showToast({title:n.data.datas.error,icon:"none"});else{var a=n.data.datas;e.id=a.member_info.member_id,e.avatar_url=a.member_info.avator,e.nickname=a.member_info.user_name}}}),t.startPullDownRefresh()},onPullDownRefresh:function(){setTimeout(function(){t.stopPullDownRefresh()},1e3)}};e.default=u}).call(this,n("6e42")["default"])},6089:function(t,e,n){"use strict";var a=n("ae04"),o=n.n(a);o.a},ae04:function(t,e,n){},c9a3:function(t,e,n){"use strict";n.r(e);var a=n("380a"),o=n.n(a);for(var r in a)"default"!==r&&function(t){n.d(e,t,function(){return a[t]})}(r);e["default"]=o.a},fa07:function(t,e,n){"use strict";var a=function(){var t=this,e=t.$createElement;t._self._c},o=[];n.d(e,"a",function(){return a}),n.d(e,"b",function(){return o})}},[["5f53","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/interest/interest"],{"59b5":function(t,e,i){},"6e3c":function(t,e,i){"use strict";i.r(e);var n=i("f77b"),s=i("e6b9");for(var o in s)"default"!==o&&function(t){i.d(e,t,function(){return s[t]})}(o);i("73c2");var c=i("2877"),r=Object(c["a"])(s["default"],n["a"],n["b"],!1,null,"9433bc98",null);e["default"]=r.exports},"73c2":function(t,e,i){"use strict";var n=i("59b5"),s=i.n(n);s.a},dd69:function(t,e,i){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var i={data:function(){return{num:0,interest_list:[{id:1,photo:"../../static/img/interest_img1.png",title:"时尚穿搭",select:0},{id:2,photo:"../../static/img/interest_img2.png",title:"发型",select:0},{id:3,photo:"../../static/img/interest_img3.png",title:"化妆品",select:0},{id:4,photo:"../../static/img/interest_img4.png",title:"数码",select:0},{id:5,photo:"../../static/img/interest_img5.png",title:"音乐器材",select:0},{id:6,photo:"../../static/img/interest_img6.png",title:"书籍",select:0},{id:7,photo:"../../static/img/interest_img7.png",title:"百货",select:0},{id:8,photo:"../../static/img/interest_img8.png",title:"汽车",select:0},{id:9,photo:"../../static/img/interest_img9.png",title:"箱包",select:0},{id:10,photo:"../../static/img/interest_img10.png",title:"鞋靴",select:0},{id:11,photo:"../../static/img/interest_img11.png",title:"生鲜",select:0},{id:12,photo:"../../static/img/interest_img12.png",title:"美食",select:0}]}},methods:{selectInterest:function(t){0==this.interest_list[t].select?(this.interest_list[t].select=1,this.num++):(this.interest_list[t].select=0,this.num--)},toNext:function(e){parseInt(this.num)<3?t.showToast({title:"至少关注3个兴趣！",duration:1e3,icon:"none"}):t.reLaunch({url:"/pages/index/index",animationType:"pop-in",animationDuration:500})}},onLoad:function(){}};e.default=i}).call(this,i("6e42")["default"])},e6b9:function(t,e,i){"use strict";i.r(e);var n=i("dd69"),s=i.n(n);for(var o in n)"default"!==o&&function(t){i.d(e,t,function(){return n[t]})}(o);e["default"]=s.a},f77b:function(t,e,i){"use strict";var n=function(){var t=this,e=t.$createElement;t._self._c},s=[];i.d(e,"a",function(){return n}),i.d(e,"b",function(){return s})}},[["0ba6","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/my_collect/my_collect"],{"05a5":function(t,e,n){"use strict";n.r(e);var o=n("1dd7"),c=n("b2e8");for(var l in c)"default"!==l&&function(t){n.d(e,t,function(){return c[t]})}(l);n("49fe");var a=n("2877"),u=Object(a["a"])(c["default"],o["a"],o["b"],!1,null,"5942fdc4",null);e["default"]=u.exports},1976:function(t,e,n){},"1dd7":function(t,e,n){"use strict";var o=function(){var t=this,e=t.$createElement;t._self._c},c=[];n.d(e,"a",function(){return o}),n.d(e,"b",function(){return c})},"49fe":function(t,e,n){"use strict";var o=n("1976"),c=n.n(o);c.a},"7f61":function(t,e,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var o=l(n("25aa")),c=l(n("61f8"));function l(t){return t&&t.__esModule?t:{default:t}}var a={data:function(){return{collect_list:[]}},methods:{},onLoad:function(){var t=this;c.default.post("index.php?act=video&op=CollectionList",{}).then(function(e){for(var n in console.log(e.list," at pages\\my_collect\\my_collect.vue:32"),t.collect_list=e.list,t.collect_list)t.collect_list[n].addtime=(0,o.default)(t.collect_list[n].addtime)})}};e.default=a},b2e8:function(t,e,n){"use strict";n.r(e);var o=n("7f61"),c=n.n(o);for(var l in o)"default"!==l&&function(t){n.d(e,t,function(){return o[t]})}(l);e["default"]=c.a}},[["c15a","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/business_info/business_info"],{"069b":function(n,t,e){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var u={data:function(){return{business:[{id:1,src:"../../static/img/store_img.jpg",title:"艾璐卡-山羊奶悦颜清透洁面乳",info:"清洁皮肤，长效保湿滋润",price:"98",type:"3.5g"}]}},methods:{},onLoad:function(){}};t.default=u},"0a9b":function(n,t,e){},"760ff":function(n,t,e){"use strict";var u=function(){var n=this,t=n.$createElement;n._self._c},i=[];e.d(t,"a",function(){return u}),e.d(t,"b",function(){return i})},d3d1:function(n,t,e){"use strict";var u=e("0a9b"),i=e.n(u);i.a},de61:function(n,t,e){"use strict";e.r(t);var u=e("760ff"),i=e("e6c5");for(var o in i)"default"!==o&&function(n){e.d(t,n,function(){return i[n]})}(o);e("d3d1");var r=e("2877"),a=Object(r["a"])(i["default"],u["a"],u["b"],!1,null,"f2b91712",null);t["default"]=a.exports},e6c5:function(n,t,e){"use strict";e.r(t);var u=e("069b"),i=e.n(u);for(var o in u)"default"!==o&&function(n){e.d(t,n,function(){return u[n]})}(o);t["default"]=i.a}},[["e0c1","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/comment/comment"],{6941:function(t,n,e){"use strict";e.r(n);var o=e("bee3"),i=e("a43e");for(var c in i)"default"!==c&&function(t){e.d(n,t,function(){return i[t]})}(c);e("d71c");var a=e("2877"),u=Object(a["a"])(i["default"],o["a"],o["b"],!1,null,"be801f44",null);n["default"]=u.exports},9694:function(t,n,e){},a43e:function(t,n,e){"use strict";e.r(n);var o=e("a567"),i=e.n(o);for(var c in o)"default"!==c&&function(t){e.d(n,t,function(){return o[t]})}(c);n["default"]=i.a},a567:function(t,n,e){"use strict";(function(t){Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var o=i(e("61f8"));function i(t){return t&&t.__esModule?t:{default:t}}var c={data:function(){return{comment_count:0,scrollTop:0,content:"",video_id:0,comment_list:[]}},methods:{back:function(){t.navigateBack({delta:1})},toSend:function(){var n=this;""==this.content&&t.showToast({title:"请填写信息",duration:2e3,icon:"none"}),console.log(this.content," at pages\\comment\\comment.vue:55"),o.default.post("index.php?act=video&op=videoComment",{video_id:this.video_id,content:this.content}).then(function(e){1==e&&(t.showToast({title:"评论成功",duration:2e3,icon:"none"}),n.content="")})},toComment:function(t){console.log(t," at pages\\comment\\comment.vue:71"),o.default.get("index.php?act=video&op=CommentPraise",{id:t}).then(function(t){console.log(t.list," at pages\\comment\\comment.vue:75")})}},onLoad:function(t){var n=this;this.video_id=t.video_id,this.comment_count=t.comment_count,o.default.post("index.php?act=video&op=CommentList",{video_id:this.video_id}).then(function(t){console.log(t.list," at pages\\comment\\comment.vue:86"),n.comment_list=t.list})}};n.default=c}).call(this,e("6e42")["default"])},bee3:function(t,n,e){"use strict";var o=function(){var t=this,n=t.$createElement;t._self._c},i=[];e.d(n,"a",function(){return o}),e.d(n,"b",function(){return i})},d71c:function(t,n,e){"use strict";var o=e("9694"),i=e.n(o);i.a}},[["2003","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/my_order/my_order"],{"012d":function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o=a(r("bebd")),n=r("2f62");function a(e){return e&&e.__esModule?e:{default:e}}var u={data:function(){return{url:"",order_state:20,webviewStyles:{progress:{color:"#FF3333"}}}},computed:(0,n.mapState)(["forcedLogin","hasLogin","userName"]),methods:{},onShow:function(){this.url=o.default.wapUrl+"/tmpl/member/order_list.html?order_state="+this.order_state+"&key="+e.getStorageSync("access_token")},onLoad:function(t){console.log(t," at pages\\my_order\\my_order.vue:32"),this.order_state=t.order_state,this.url=o.default.wapUrl+"/tmpl/member/order_list.html?order_state="+t.order_state+"&key="+e.getStorageSync("access_token")}};t.default=u}).call(this,r("6e42")["default"])},d77c:function(e,t,r){"use strict";r.r(t);var o=r("012d"),n=r.n(o);for(var a in o)"default"!==a&&function(e){r.d(t,e,function(){return o[e]})}(a);t["default"]=n.a},dd5f:function(e,t,r){"use strict";var o=function(){var e=this,t=e.$createElement;e._self._c},n=[];r.d(t,"a",function(){return o}),r.d(t,"b",function(){return n})},ef43:function(e,t,r){"use strict";r.r(t);var o=r("dd5f"),n=r("d77c");for(var a in n)"default"!==a&&function(e){r.d(t,e,function(){return n[e]})}(a);var u=r("2877"),d=Object(u["a"])(n["default"],o["a"],o["b"],!1,null,"4f88ddf8",null);t["default"]=d.exports}},[["98be","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/car/car"],{"39a9":function(t,e,n){"use strict";var a=function(){var t=this,e=t.$createElement;t._self._c},r=[];n.d(e,"a",function(){return a}),n.d(e,"b",function(){return r})},"7a6a":function(t,e,n){"use strict";n.r(e);var a=n("39a9"),r=n("b7a4");for(var u in r)"default"!==u&&function(t){n.d(e,t,function(){return r[t]})}(u);var o=n("2877"),c=Object(o["a"])(r["default"],a["a"],a["b"],!1,null,"276649cb",null);e["default"]=c.exports},"88f3":function(t,e,n){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var a=u(n("bebd")),r=n("2f62");function u(t){return t&&t.__esModule?t:{default:t}}var o={data:function(){return{url:"",webviewStyles:{progress:{color:"#FF3333"}}}},computed:(0,r.mapState)(["forcedLogin","hasLogin","userName"]),methods:{},onShow:function(){this.url=a.default.wapUrl+"tmpl/cart_list.html?key="+t.getStorageSync("access_token"),console.log(this.url," at pages\\car\\car.vue:38")}};e.default=o}).call(this,n("6e42")["default"])},b7a4:function(t,e,n){"use strict";n.r(e);var a=n("88f3"),r=n.n(a);for(var u in a)"default"!==u&&function(t){n.d(e,t,function(){return a[t]})}(u);e["default"]=r.a}},[["3156","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/settings/settings"],{"1c47":function(e,t,a){},3370:function(e,t,a){"use strict";var s=function(){var e=this,t=e.$createElement;e._self._c},n=[];a.d(t,"a",function(){return s}),a.d(t,"b",function(){return n})},"4a78":function(e,t,a){"use strict";a.r(t);var s=a("f3cf"),n=a.n(s);for(var r in s)"default"!==r&&function(e){a.d(t,e,function(){return s[e]})}(r);t["default"]=n.a},c1ff:function(e,t,a){"use strict";a.r(t);var s=a("3370"),n=a("4a78");for(var r in n)"default"!==r&&function(e){a.d(t,e,function(){return n[e]})}(r);a("e6a0");var o=a("2877"),i=Object(o["a"])(n["default"],s["a"],s["b"],!1,null,"3bc28192",null);t["default"]=i.exports},e6a0:function(e,t,a){"use strict";var s=a("1c47"),n=a.n(s);n.a},f3cf:function(e,t,a){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a={data:function(){return{username:"",age:"",children:0,id_card:"",radio_sex:[{value:"0",name:"男"},{value:"1",name:"女"}],radio_marry:[{value:"0",name:"是"},{value:"1",name:"否"}],radio_bear:[{value:"0",name:"是"},{value:"1",name:"否"}],sex_current:0,marry_current:0,bear_current:0,idcard_up:"",idcard_down:"",user_real:0,code:"",userinfo:"",providerList:"",avatar_url:"",nickname:"",wechat_open_id:"",is_wx:0}},methods:{initProvider:function(){var t=this,a=["weixin"];e.getProvider({service:"oauth",success:function(e){if(e.provider&&e.provider.length)for(var s=0;s<e.provider.length;s++)~a.indexOf(e.provider[s])&&(t.providerList=e.provider[s],console.log(t.providerList," at pages\\settings\\settings.vue:141"))},fail:function(e){console.error("获取服务供应商失败："+JSON.stringify(e)," at pages\\settings\\settings.vue:147")}})},getUsername:function(e){this.username=e.detail.value,console.log(this.username," at pages\\settings\\settings.vue:153")},getAge:function(e){this.age=e.detail.value,console.log(this.age," at pages\\settings\\settings.vue:157")},getChildren:function(e){this.children=e.detail.value,console.log(this.children," at pages\\settings\\settings.vue:161")},getIdcard:function(e){this.id_card=e.detail.value,console.log(this.id_card," at pages\\settings\\settings.vue:165")},sexChange:function(e){for(var t=0;t<this.radio_sex.length;t++)if(this.radio_sex[t].value===e.target.value){this.sex_current=t;break}console.log(this.sex_current," at pages\\settings\\settings.vue:174")},marryChange:function(e){for(var t=0;t<this.radio_marry.length;t++)if(this.radio_marry[t].value===e.target.value){this.marry_current=t;break}console.log(this.marry_current," at pages\\settings\\settings.vue:183")},bearChange:function(e){for(var t=0;t<this.radio_bear.length;t++)if(this.radio_bear[t].value===e.target.value){this.bear_current=t;break}console.log(this.bear_current," at pages\\settings\\settings.vue:192")},selectCardUp:function(){var t=this;e.chooseImage({count:1,sizeType:["original","compressed"],sourceType:["album"],success:function(a){console.log(JSON.stringify(a.tempFilePaths)," at pages\\settings\\settings.vue:201");e.uploadFile({url:t.$api+"default/upload-image",filePath:a.tempFilePaths[0],name:"image",success:function(a){console.log(a.data," at pages\\settings\\settings.vue:207");var s=JSON.parse(a.data);0==s.code?t.idcard_up=s.data.url:e.showToast({title:s.msg,icon:"none"})}})}})},selectCardDown:function(){var t=this;e.chooseImage({count:1,sizeType:["original","compressed"],sourceType:["album"],success:function(a){console.log(JSON.stringify(a.tempFilePaths)," at pages\\settings\\settings.vue:229"),e.uploadFile({url:t.$api+"default/upload-image",filePath:a.tempFilePaths[0],name:"image",success:function(a){console.log(a.data," at pages\\settings\\settings.vue:235");var s=JSON.parse(a.data);0==s.code?t.idcard_down=s.data.url:e.showToast({title:s.msg,icon:"none"})}})}})},appLogin:function(t){console.log(t," at pages\\settings\\settings.vue:252");var a=this;console.log(a.$access_token," at pages\\settings\\settings.vue:254"),e.login({provider:t,success:function(s){e.getUserInfo({provider:t,success:function(t){e.request({url:a.$api+"user/agent-information/&access_token="+a.$access_token,dataType:"json",method:"POST",data:{nickname:t.userInfo.nickName,wechat_open_id:t.userInfo.openId,avatar_url:t.userInfo.avatarUrl},header:{"content-type":"application/x-www-form-urlencoded"},success:function(t){t.data.data;0==t.data.code?(a.is_wx=1,e.showToast({title:t.data.msg,icon:"none"})):e.showToast({title:t.data.msg,icon:"none"})}})}})},fail:function(t){e.showToast({title:"授权登录失败："+t.errMsg,icon:"none",duration:1500})}})},formSubmit:function(){var t=this;return""==t.username?(e.showToast({title:"请填写姓名",icon:"none",duration:1e3}),!1):0==t.age||""==t.age?(e.showToast({title:"请输入年龄",icon:"none",duration:1e3}),!1):(console.log(t.idcard_up," at pages\\settings\\settings.vue:320"),console.log(t.idcard_down," at pages\\settings\\settings.vue:321"),0==t.idcard_up?(e.showToast({title:"请上传身份证正面照",icon:"none",duration:1e3}),!1):0==t.idcard_down?(e.showToast({title:"请上传身份证反面照",icon:"none",duration:1e3}),!1):void e.request({url:t.$api+"user/setting-edit&access_token="+t.$access_token,method:"POST",data:{user_name:t.username,user_age:t.age,user_sex:t.sex_current,user_marry:t.marry_current,user_rear:t.bear_current,user_child:t.children,user_just:t.idcard_up,user_back:t.idcard_down},dataType:"json",header:{"content-type":"application/x-www-form-urlencoded"},success:function(a){a.data.data;0==a.data.code?(e.showToast({title:a.data.msg,icon:"none",duration:1e3}),e.setStorageSync("user_name",t.username),t.$user_name=e.getStorageSync("user_name"),setTimeout(function(){e.reLaunch({url:"/pages/person/person"})},1500)):e.showToast({title:a.data.msg,icon:"none",duration:1e3})},fail:function(){e.showToast({title:res.data.msg,icon:"none"})}}))}},onReady:function(){var e=this;e.initProvider(),console.log(e.providerList," at pages\\settings\\settings.vue:395")},onLoad:function(t){var a=this;a.$access_token=e.getStorageSync("access_token"),a.$level=e.getStorageSync("level"),e.request({url:a.$api+"user/setting/&access_token="+a.$access_token,dataType:"json",method:"GET",header:{"content-type":"application/x-www-form-urlencoded"},success:function(t){var s=t.data.data;0==t.data.code?(a.username=s.user_name,a.age=s.user_age,a.sex_current=s.user_sex,a.marry_current=s.user_marry,a.bear_current=s.user_rear,a.children=s.user_child,a.idcard_up=s.user_just,a.idcard_down=s.user_back,a.user_real=s.user_real,a.is_wx=s.is_wx):e.showToast({title:t.data.msg,icon:"none"})},fail:function(){e.showToast({title:res.data.msg,icon:"none"})}})}};t.default=a}).call(this,a("6e42")["default"])}},[["a050","common/runtime","common/vendor"]]]);
});
